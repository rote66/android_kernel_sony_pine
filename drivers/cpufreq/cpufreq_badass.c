 ...
 * published by the Free Software Foundation. test
 */
...
#define TWO_PHASE_FREQ				(14976000)
#define THREE_PHASE_FREQ			(14976000)
...
static inline void bds_timer_init(struct cpu_bds_info_s *bds_info)
{
	...
	bds_info->sample_type = BDS_NORMAL_SAMPLE;
	INIT_DELAYED_WORK(&bds_info->work, do_bds_timer);
