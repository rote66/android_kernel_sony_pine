...
static const int async_read_expire = (HZ / 1);	/* ditto for async, these limits are SOFT! */
static const int async_write_expire = (HZ * 4);	/* ditto for async, these limits are SOFT! */

static const int writes_starved = 1;		/* max times reads can starve a write */
static const int fifo_batch     = 5;		/* # of sequential requests treated as one
